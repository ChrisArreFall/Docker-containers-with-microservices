...
type Orden struct {
	ID    int64   `json:"orden_id"`
	cliente_id  int64  `json:"cliente_id"`
	sucursal_id  int64  `json:"sucursal_id"`
			...
			*/
			"ORDEN": &graphql.Field{
				...
				Args: graphql.FieldConfigArgument{
					"orden_id": &graphql.ArgumentConfig{
						Type: graphql.Int,
					},
				},
				Resolve: func(p graphql.ResolveParams) (interface{}, error) {
					id, ok := p.Args["orden_id"].(int)
					if ok {
						// Find product
...
func main() {
	http.HandleFunc("/orden", func(w http.ResponseWriter, r *http.Request) {
